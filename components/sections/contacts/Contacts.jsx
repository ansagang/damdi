                                                    ...
                                                    offices.data.map((office, i) => (
                                                        <div className="contacts__item" key={i} >
                                                            ...
                                                            <div className="contacts__item-upper">
                                                                <div className="contacts__item-title title">
                                                                    <h2>{office.title}</h2>
                                                                </div>
                                                                <div className="contacts__item-info info">
                                                                    <p>{office.address}</p>
                                                                </div>
                                                            </div>
                                                            <div className="contacts__item-lower">
                                                                <div className="contacts__item-schedule info">
                                                                    <p>{office.schedule.start} - {office.schedule.end}</p>
                                                                </div>
                                                                <div className="contacts__item-phone info">
