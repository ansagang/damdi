            ...
            <div className="container">
                <div className="account-details__inner inner">
                    ...
                    <div className="account-details__form">
                        <div className="account-details__form-inputs">
                            <div className="account-details__form-input">
                                <div className="account-details__form-input_info info">
                        ...
                        <div className="account-details__form-buttons">
                            <button onClick={() => {
                                    ...
                                    // const [country, setCountry] = useState(account.data.shipping ? account.data.shipping.country : null)
                                    // const [district, setDistrict] = useState(account.data.shipping ? account.data.shipping.district : null)
                            }} disabled={username !== account.data.username || email !== account.data.email || fullname !== account.data.fullname || phone !== account.data.phone || lang !== account.data.lang || country !== account.data.shipping.country || city !== account.data.shipping.city || district !== account.data.shipping.district || address !== account.data.shipping.address ? false : true} className="account-details__form-button secondary" type="button">{language.account.details.buttons.cancel}</button>
